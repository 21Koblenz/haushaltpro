...
checks = {
    ...
    "alpine_security_upgrade": "apk upgrade --no-cache" in dockerfile,
    "pip_dependency_check": "python -m pip check" in dockerfile,
    "runtime_pip_removed": "/usr/local/lib/python3.12/site-packages/pip" in dockerfile and "/usr/local/bin/pip3.12" in dockerfile,
    "runtime_setuptools_removed": "/usr/local/lib/python3.12/site-packages/setuptools" in dockerfile and "/usr/local/lib/python3.12/site-packages/pkg_resources" in dockerfile,
    "runtime_wheel_removed": "/usr/local/lib/python3.12/site-packages/wheel" in dockerfile,
    "runtime_ensurepip_removed": "/usr/local/lib/python3.12/ensurepip" in dockerfile,
    "runtime_dependency_smoke": "import fastapi,starlette,uvicorn,pydantic,argon2,cryptography,multipart" in dockerfile and "PRAGMA cipher_version" in dockerfile,
